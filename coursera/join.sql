...
insert into proveedor (id, nombre) values(1, 'Lenovo');
insert into proveedor (id, nombre) values(2, 'Logitech');
insert into proveedor (id, nombre) values(3, 'Microsoft'); 
insert into proveedor (id, nombre) values(4, 'HP');

insert into productos(id, nombre, descripcion, proveedorid, precio, cantidad) 
values(1, 'Lenovo 310', 'La mejor laptop', 1, 100, 50);
insert into productos(id, nombre, descripcion, proveedorid, precio, cantidad) 
values(2,'Mouse', 'mouse inalambrico', 2, 15.96, 5);
insert into productos(id, nombre, descripcion, proveedorid, precio, cantidad) 
values(3, 'Office 360', 'Paquete de Ofice', 3, 150.69, 30);
insert into productos(id, nombre, descripcion, proveedorid, precio, cantidad) 
values(4, 'HP Y700', 'La mejor laptop del mercado', 4, 10, 15);
insert into productos(id, nombre, descripcion, proveedorid, precio, cantidad) 
values(5, 'Alfombra Lenovo', 'Alfombras asombrosas', 1, 300, 40);
insert into productos(id, nombre, descripcion, proveedorid, precio, cantidad) 
values(6, 'laptop HP 1000', 'No funciona muy bien',4 , 500, 3);
insert into productos(id, nombre, descripcion, proveedorid, precio, cantidad) 
values(7, 'Volante Gamer', 'El mejor volante para jugar', 2, 800, 5);
insert into productos(id, nombre, descripcion, proveedorid, precio, cantidad) 
values(8, 'Disco duro', 'Obten mas capacidad', 3, 70, 80);
